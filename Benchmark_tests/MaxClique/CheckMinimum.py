...
for prob in P:
    ...
    for dim in range(MinProblemDimension, MaxProblemDimension + 1, 2):
        ...
        for num_prob in range(ProblemForEachDimension):
            ...
            try:
                resfile = open("Results/MaxClique_" + format(dim) + "_nodes_P" + format(prob) + "_" + format(num_prob) + "_n_sol.txt", "r")
            except:
            ...
            for line in resfile:
                ...
                if splitted_line[0] == "Error":
                    errfile.write("ERROR: MaxClique_" + format(dim) + "_nodes_P" + format(prob) + "_" + format(num_prob) + "_n_sol.txt ")
                ...
                if splitted_line[0] == "Shannon_Error":
                    shannon_errfile.write("ERROR: MaxClique_" + format(dim) + "_nodes_P" + format(prob) + "_" + format(num_prob) + "_n_sol.txt ")
            ...
            try:
                resfile = open("Results/MaxClique_" + format(dim) + "_nodes_P" + format(prob) + "_" + format(num_prob) + "_n.txt", "r")
            except:
                print("Error in file opening\n")
                exit(1)
